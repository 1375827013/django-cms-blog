...
class StudentProfile(models.Model):
    ...
    subject_type = models.CharField('科类', max_length=10, choices=[('物理类', '物理类'), ('历史类', '历史类')], default='物理类')
...
class AdmissionScore(models.Model):
    ...
    subject_type = models.CharField('科类', max_length=10, choices=[('物理类', '物理类'), ('历史类', '历史类')])
